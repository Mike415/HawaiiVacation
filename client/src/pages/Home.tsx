    ...
    plans: [
      {
        ...
        waypoints: [
          { label: "Kahului Airport (OGG)", address: "Kahului Airport, Kahului, Maui, HI", note: "Arrival & car rental", driveTime: "45 min", driveDist: "27 mi" },
          { label: "Westin Ka'anapali Ocean Resort Villas", address: "Westin Ka'anapali Ocean Resort Villas, Lahaina, Maui, HI", note: "Check-in", driveTime: "5 min", driveDist: "1.5 mi" },
          { label: "Black Rock (Pu'u Keka'a)", address: "Pu'u Keka'a Black Rock, Ka'anapali, Maui, HI", note: "Sunset cliff diving", driveTime: "3 min", driveDist: "0.8 mi" },
          { label: "Westin Ka'anapali Ocean Resort Villas", address: "Westin Ka'anapali Ocean Resort Villas, Lahaina, Maui, HI", note: "Return to resort" },
        ],
      ...
      },
      {
        ...
        waypoints: [
          { label: "Kahului Airport (OGG)", address: "Kahului Airport, Kahului, Maui, HI", note: "Arrival", driveTime: "10 min", driveDist: "7 mi" },
          { label: "Paia Town", address: "Paia, Maui, HI", note: "Lunch & browse", driveTime: "5 min", driveDist: "0.5 mi" },
          { label: "Waikomo Shave Ice", address: "Waikomo Shave Ice, Paia, Maui, HI", note: "First shave ice!", driveTime: "55 min", driveDist: "35 mi" },
          { label: "Westin Ka'anapali Ocean Resort Villas", address: "Westin Ka'anapali Ocean Resort Villas, Lahaina, Maui, HI", note: "Check-in" },
        ],
    ...
    plans: [
      {
        ...
        waypoints: [
          { label: "Westin Ka'anapali Ocean Resort Villas", address: "Westin Ka'anapali Ocean Resort Villas, Lahaina, Maui, HI", note: "Start", driveTime: "14 min", driveDist: "5.5 mi" },
          { label: "Kapalua Bay Beach", address: "Kapalua Bay, Lahaina, Maui, HI", note: "Morning beach", driveTime: "1 min", driveDist: "0.1 mi" },
          { label: "Napili Bay", address: "Napili Bay, Lahaina, Maui, HI", note: "Lunch picnic", driveTime: "15 min", driveDist: "6.4 mi" },
          { label: "Hula Grill Ka'anapali", address: "Hula Grill Ka'anapali, Lahaina, Maui, HI", note: "Barefoot Bar dinner", driveTime: "15 min", driveDist: "6.4 mi" },
          { label: "Westin Ka'anapali Ocean Resort Villas", address: "Westin Ka'anapali Ocean Resort Villas, Lahaina, Maui, HI", note: "Return to resort" },
        ],
      ...
      },
      {
        ...
        waypoints: [
          { label: "Westin Ka'anapali Ocean Resort Villas", address: "Westin Ka'anapali Ocean Resort Villas, Lahaina, Maui, HI", note: "Start", driveTime: "3 min", driveDist: "0.8 mi" },
          { label: "Black Rock (Pu'u Keka'a)", address: "Pu'u Keka'a Black Rock, Ka'anapali, Maui, HI", note: "Beach morning", driveTime: "2 min", driveDist: "0.5 mi" },
          { label: "Leilani's on the Beach", address: "Leilani's on the Beach, Whalers Village, Ka'anapali, Maui, HI", note: "Lunch", driveTime: "5 min", driveDist: "1 mi" },
          { label: "Westin Ka'anapali Ocean Resort Villas", address: "Westin Ka'anapali Ocean Resort Villas, Lahaina, Maui, HI", note: "Return to resort" },
        ],
    ...
    plans: [
      {
        ...
        waypoints: [
          { label: "Westin Ka'anapali Ocean Resort Villas", address: "Westin Ka'anapali Ocean Resort Villas, Lahaina, Maui, HI", note: "Start", driveTime: "20 min", driveDist: "12 mi" },
          { label: "Maui Ocean Center", address: "Maui Ocean Center, Ma'alaea, Maui, HI", note: "9am opening", driveTime: "20 min", driveDist: "11 mi" },
          { label: "Lahaina Banyan Tree", address: "Lahaina Banyan Court Mall, Lahaina, Maui, HI", note: "Iconic tree + lunch", driveTime: "2 min", driveDist: "0.3 mi" },
          { label: "Ululani's Shave Ice Lahaina", address: "Ululani's Hawaiian Shave Ice, Lahaina, Maui, HI", note: "Shave ice!", driveTime: "20 min", driveDist: "11 mi" },
          { label: "Westin Ka'anapali Ocean Resort Villas", address: "Westin Ka'anapali Ocean Resort Villas, Lahaina, Maui, HI", note: "Return to resort" },
        ],
      ...
      },
      {
        ...
        waypoints: [
          { label: "Westin Ka'anapali Ocean Resort Villas", address: "Westin Ka'anapali Ocean Resort Villas, Lahaina, Maui, HI", note: "Start", driveTime: "18 min", driveDist: "10 mi" },
          { label: "Maui Tropical Plantation", address: "Maui Tropical Plantation, Waikapu, Maui, HI", note: "Tram tour + lunch", driveTime: "15 min", driveDist: "8 mi" },
          { label: "Lahaina Banyan Tree", address: "Lahaina Banyan Court Mall, Lahaina, Maui, HI", note: "Shave ice & stroll", driveTime: "18 min", driveDist: "10 mi" },
          { label: "Westin Ka'anapali Ocean Resort Villas", address: "Westin Ka'anapali Ocean Resort Villas, Lahaina, Maui, HI", note: "Return" },
        ],
    ...
    plans: [
      {
        ...
        waypoints: [
          { label: "Westin Ka'anapali Ocean Resort Villas", address: "Westin Ka'anapali Ocean Resort Villas, Lahaina, Maui, HI", note: "Start", driveTime: "45 min", driveDist: "28 mi" },
          { label: "Mama's Fish House", address: "Mama's Fish House, 799 Poho Pl, Paia, Maui, HI", note: "Legendary lunch", driveTime: "5 min", driveDist: "1.5 mi" },
          { label: "Ho'okipa Beach Lookout", address: "Ho'okipa Beach Park, Paia, Maui, HI", note: "Turtles & surfers", driveTime: "45 min", driveDist: "28 mi" },
          { label: "Westin Ka'anapali Ocean Resort Villas", address: "Westin Ka'anapali Ocean Resort Villas, Lahaina, Maui, HI", note: "Return" },
        ],
      ...
      },
      {
        ...
        waypoints: [
          { label: "Westin Ka'anapali Ocean Resort Villas", address: "Westin Ka'anapali Ocean Resort Villas, Lahaina, Maui, HI", note: "Start", driveTime: "30 min", driveDist: "19 mi" },
          { label: "Big Beach (Mākena State Park)", address: "Makena State Beach and Nature Park, Makena, Maui, HI", note: "Beach morning", driveTime: "15 min", driveDist: "8 mi" },
          { label: "Ululani's Shave Ice Kihei", address: "Ululani's Hawaiian Shave Ice, Kihei, Maui, HI", note: "Shave ice stop", driveTime: "30 min", driveDist: "19 mi" },
          { label: "Westin Ka'anapali Ocean Resort Villas", address: "Westin Ka'anapali Ocean Resort Villas, Lahaina, Maui, HI", note: "Return" },
        ],
    ...
    plans: [
      {
        ...
        waypoints: [
          { label: "Westin Ka'anapali Ocean Resort Villas", address: "Westin Ka'anapali Ocean Resort Villas, Lahaina, Maui, HI", note: "Start", driveTime: "35 min", driveDist: "18 mi" },
          { label: "Kahakuloa Village", address: "Kahakuloa, Maui, HI", note: "Scenic drive stop", driveTime: "25 min", driveDist: "12 mi" },
          { label: "Foodland Farms Lahaina", address: "Foodland Farms, 345 Keawe St, Lahaina, Maui, HI", note: "Poke bowls", driveTime: "10 min", driveDist: "5 mi" },
          { label: "Napili Bay", address: "Napili Bay, Lahaina, Maui, HI", note: "Beach picnic", driveTime: "5 min", driveDist: "2 mi" },
          { label: "Westin Ka'anapali Ocean Resort Villas", address: "Westin Ka'anapali Ocean Resort Villas, Lahaina, Maui, HI", note: "Return to resort" },
        ],
      ...
      },
      {
        ...
        waypoints: [
          { label: "Westin Ka'anapali Ocean Resort Villas", address: "Westin Ka'anapali Ocean Resort Villas, Lahaina, Maui, HI", note: "Depart 7am", driveTime: "50 min", driveDist: "32 mi" },
          { label: "Twin Falls", address: "Twin Falls, Hana Highway, Haiku, Maui, HI", note: "Waterfall hike", driveTime: "40 min", driveDist: "19 mi" },
          { label: "Ke'anae Peninsula", address: "Ke'anae Peninsula, Ke'anae, Maui, HI", note: "Banana bread stand", driveTime: "1 hr 20 min", driveDist: "51 mi" },
          { label: "Westin Ka'anapali Ocean Resort Villas", address: "Westin Ka'anapali Ocean Resort Villas, Lahaina, Maui, HI", note: "Return by noon" },
        ],
    ...
    plans: [
      {
        ...
        waypoints: [
          { label: "Westin Ka'anapali Ocean Resort Villas", address: "Westin Ka'anapali Ocean Resort Villas, Lahaina, Maui, HI", note: "Morning beach day", driveTime: "10 min", driveDist: "4 mi" },
          { label: "Old Lāhainā Lūʻau", address: "Old Lahaina Luau, 1251 Front St, Lahaina, Maui, HI", note: "Gates open 5:15pm", driveTime: "10 min", driveDist: "4 mi" },
          { label: "Westin Ka'anapali Ocean Resort Villas", address: "Westin Ka'anapali Ocean Resort Villas, Lahaina, Maui, HI", note: "Return after luau" },
        ],
        mapCenter: { lat: 20.9281, lng: -156.6825 },
        mapZoom: 13,
      },
      {
        ...
        waypoints: [
          { label: "Westin Ka'anapali Ocean Resort Villas", address: "Westin Ka'anapali Ocean Resort Villas, Lahaina, Maui, HI", note: "Morning beach", driveTime: "3 min", driveDist: "0.7 mi" },
          { label: "Hyatt Regency Maui", address: "Hyatt Regency Maui Resort and Spa, Ka'anapali, Maui, HI", note: "Drums of the Pacific Luau", driveTime: "3 min", driveDist: "0.7 mi" },
          { label: "Westin Ka'anapali Ocean Resort Villas", address: "Westin Ka'anapali Ocean Resort Villas, Lahaina, Maui, HI", note: "Return after luau" },
        ],
        mapCenter: { lat: 20.9281, lng: -156.6900 },
        mapZoom: 14,
    ...
    plans: [
      {
        ...
        waypoints: [
          { label: "Westin Ka'anapali Ocean Resort Villas", address: "Westin Ka'anapali Ocean Resort Villas, Lahaina, Maui, HI", note: "Final beach walk & checkout", driveTime: "10 min", driveDist: "4 mi" },
          { label: "Ululani's Shave Ice Lahaina", address: "Ululani's Hawaiian Shave Ice, Lahaina, Maui, HI", note: "Last shave ice", driveTime: "45 min", driveDist: "27 mi" },
          { label: "Kahului Airport (OGG)", address: "Kahului Airport, Kahului, Maui, HI", note: "Depart" },
        ],
      ...
      },
      {
        ...
        waypoints: [
          { label: "Westin Ka'anapali Ocean Resort Villas", address: "Westin Ka'anapali Ocean Resort Villas, Lahaina, Maui, HI", note: "Checkout", driveTime: "14 min", driveDist: "5.5 mi" },
          { label: "Kapalua Bay Beach", address: "Kapalua Bay, Lahaina, Maui, HI", note: "Final swim", driveTime: "14 min", driveDist: "5.5 mi" },
          { label: "Ululani's Shave Ice Kahului", address: "Ululani's Hawaiian Shave Ice, 333 Dairy Rd, Kahului, Maui, HI", note: "Last shave ice", driveTime: "5 min", driveDist: "2 mi" },
          { label: "Kahului Airport (OGG)", address: "Kahului Airport, Kahului, Maui, HI", note: "Depart" },
        ],
        mapCenter: { lat: 20.9281, lng: -156.6500 },
        mapZoom: 11,
