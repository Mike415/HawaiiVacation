    ...
    plans: [
      {
        ...
        title: "Honua Kai Check-In & Pool Time",
          ...
          {
            title: "Duke's Beach House — First Night Dinner ✓ CONFIRMED",
            detail: "Reservation confirmed: Thursday, May 28 at 6:30 PM · Party of 4. Duke's Beach House sits right on the sand at Honua Kai Resort — you can practically walk from your suite. Named after legendary surfer Duke Kahanamoku, the open-air oceanfront setting is iconic. Fresh island fish, mai tais, great kids' menu, and live Hawaiian music nightly. One of the most beloved beachfront restaurants on Maui.",
            tip: "Confirmed 6:30pm, party of 4. The fresh catch, fish tacos, and Duke's famous hula pie are the move. It's steps from Honua Kai so no driving needed on arrival night.",
            image: IMAGES.hero,
