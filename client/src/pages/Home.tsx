    ...
    plans: [
      {
        ...
        waypoints: [
          { label: "Kahului Airport (OGG)", address: "Kahului Airport Maui", note: "Arrival & car rental", driveTime: "45 min", driveDist: "27 mi" },
          { label: "Westin Ka'anapali Ocean Resort Villas", address: "Westin Kaanapali Ocean Resort Villas Maui", note: "Check-in", driveTime: "5 min", driveDist: "1.5 mi" },
          { label: "Black Rock (Pu'u Keka'a)", address: "Black Rock Kaanapali Maui", note: "Sunset cliff diving", driveTime: "3 min", driveDist: "0.8 mi" },
          { label: "Westin Ka'anapali Ocean Resort Villas", address: "Westin Kaanapali Ocean Resort Villas Maui", note: "Return to resort" },
        ],
      ...
      },
      {
        ...
        waypoints: [
          { label: "Kahului Airport (OGG)", address: "Kahului Airport Maui", note: "Arrival", driveTime: "10 min", driveDist: "7 mi" },
          { label: "Paia Town", address: "Paia Town Maui", note: "Lunch & browse", driveTime: "5 min", driveDist: "0.5 mi" },
          { label: "Waikomo Shave Ice", address: "Waikomo Shave Ice Paia Maui", note: "First shave ice!", driveTime: "55 min", driveDist: "35 mi" },
          { label: "Westin Ka'anapali Ocean Resort Villas", address: "Westin Kaanapali Ocean Resort Villas Maui", note: "Check-in" },
        ],
    ...
    plans: [
      {
        ...
        waypoints: [
          { label: "Westin Ka'anapali Ocean Resort Villas", address: "Westin Kaanapali Ocean Resort Villas Maui", note: "Start", driveTime: "14 min", driveDist: "5.5 mi" },
          { label: "Kapalua Bay Beach", address: "Kapalua Bay Beach Maui", note: "Morning beach", driveTime: "1 min", driveDist: "0.1 mi" },
          { label: "Napili Bay", address: "Napili Bay Maui", note: "Lunch picnic", driveTime: "15 min", driveDist: "6.4 mi" },
          { label: "Hula Grill Ka'anapali", address: "Hula Grill Kaanapali Maui", note: "Barefoot Bar dinner", driveTime: "15 min", driveDist: "6.4 mi" },
          { label: "Westin Ka'anapali Ocean Resort Villas", address: "Westin Kaanapali Ocean Resort Villas Maui", note: "Return to resort" },
        ],
      ...
      },
      {
        ...
        waypoints: [
          { label: "Westin Ka'anapali Ocean Resort Villas", address: "Westin Kaanapali Ocean Resort Villas Maui", note: "Start", driveTime: "3 min", driveDist: "0.8 mi" },
          { label: "Black Rock (Pu'u Keka'a)", address: "Black Rock Kaanapali Maui", note: "Beach morning", driveTime: "2 min", driveDist: "0.5 mi" },
          { label: "Leilani's on the Beach", address: "Leilani's on the Beach Whalers Village Maui", note: "Lunch", driveTime: "5 min", driveDist: "1 mi" },
          { label: "Westin Ka'anapali Ocean Resort Villas", address: "Westin Kaanapali Ocean Resort Villas Maui", note: "Return to resort" },
        ],
    ...
    plans: [
      {
        ...
        waypoints: [
          { label: "Westin Ka'anapali Ocean Resort Villas", address: "Westin Kaanapali Ocean Resort Villas Maui", note: "Start", driveTime: "20 min", driveDist: "12 mi" },
          { label: "Maui Ocean Center", address: "Maui Ocean Center Maalaea", note: "9am opening", driveTime: "20 min", driveDist: "11 mi" },
          { label: "Lahaina Banyan Tree", address: "Lahaina Banyan Tree Maui", note: "Iconic tree + lunch", driveTime: "2 min", driveDist: "0.3 mi" },
          { label: "Ululani's Shave Ice Lahaina", address: "Ululani's Hawaiian Shave Ice Lahaina", note: "Shave ice!", driveTime: "20 min", driveDist: "11 mi" },
          { label: "Westin Ka'anapali Ocean Resort Villas", address: "Westin Kaanapali Ocean Resort Villas Maui", note: "Return to resort" },
        ],
      ...
      },
      {
        ...
        waypoints: [
          { label: "Westin Ka'anapali Ocean Resort Villas", address: "Westin Kaanapali Ocean Resort Villas Maui", note: "Start", driveTime: "18 min", driveDist: "10 mi" },
          { label: "Maui Tropical Plantation", address: "Maui Tropical Plantation Waikapu", note: "Tram tour + lunch", driveTime: "15 min", driveDist: "8 mi" },
          { label: "Lahaina Banyan Tree", address: "Lahaina Banyan Tree Maui", note: "Shave ice & stroll", driveTime: "18 min", driveDist: "10 mi" },
          { label: "Westin Ka'anapali Ocean Resort Villas", address: "Westin Kaanapali Ocean Resort Villas Maui", note: "Return" },
        ],
    ...
    plans: [
      {
        ...
        waypoints: [
          { label: "Westin Ka'anapali Ocean Resort Villas", address: "Westin Kaanapali Ocean Resort Villas Maui", note: "Start", driveTime: "45 min", driveDist: "28 mi" },
          { label: "Mama's Fish House", address: "Mama's Fish House Paia Maui", note: "Legendary lunch", driveTime: "5 min", driveDist: "1.5 mi" },
          { label: "Ho'okipa Beach Lookout", address: "Hookipa Beach Park Maui", note: "Turtles & surfers", driveTime: "45 min", driveDist: "28 mi" },
          { label: "Westin Ka'anapali Ocean Resort Villas", address: "Westin Kaanapali Ocean Resort Villas Maui", note: "Return" },
        ],
      ...
      },
      {
        ...
        waypoints: [
          { label: "Westin Ka'anapali Ocean Resort Villas", address: "Westin Kaanapali Ocean Resort Villas Maui", note: "Start", driveTime: "30 min", driveDist: "19 mi" },
          { label: "Big Beach (Mākena State Park)", address: "Makena State Park Maui", note: "Beach morning", driveTime: "15 min", driveDist: "8 mi" },
          { label: "Ululani's Shave Ice Kihei", address: "Ululani's Hawaiian Shave Ice Kihei", note: "Shave ice stop", driveTime: "30 min", driveDist: "19 mi" },
          { label: "Westin Ka'anapali Ocean Resort Villas", address: "Westin Kaanapali Ocean Resort Villas Maui", note: "Return" },
        ],
    ...
    plans: [
      {
        ...
        waypoints: [
          { label: "Westin Ka'anapali Ocean Resort Villas", address: "Westin Kaanapali Ocean Resort Villas Maui", note: "Start", driveTime: "35 min", driveDist: "18 mi" },
          { label: "Kahakuloa Village", address: "Kahakuloa Village Maui", note: "Scenic drive stop", driveTime: "25 min", driveDist: "12 mi" },
          { label: "Foodland Farms Lahaina", address: "Foodland Farms Lahaina Maui", note: "Poke bowls", driveTime: "10 min", driveDist: "5 mi" },
          { label: "Napili Bay", address: "Napili Bay Maui", note: "Beach picnic", driveTime: "5 min", driveDist: "2 mi" },
          { label: "Westin Ka'anapali Ocean Resort Villas", address: "Westin Kaanapali Ocean Resort Villas Maui", note: "Return to resort" },
        ],
      ...
      },
      {
        ...
        waypoints: [
          { label: "Westin Ka'anapali Ocean Resort Villas", address: "Westin Kaanapali Ocean Resort Villas Maui", note: "Depart 7am", driveTime: "50 min", driveDist: "32 mi" },
          { label: "Twin Falls", address: "Twin Falls Maui Hana Highway", note: "Waterfall hike", driveTime: "40 min", driveDist: "19 mi" },
          { label: "Ke'anae Peninsula", address: "Keanae Peninsula Maui", note: "Banana bread stand", driveTime: "1 hr 20 min", driveDist: "51 mi" },
          { label: "Westin Ka'anapali Ocean Resort Villas", address: "Westin Kaanapali Ocean Resort Villas Maui", note: "Return by noon" },
        ],
    ...
    plans: [
      {
        ...
        waypoints: [
          { label: "Westin Ka'anapali Ocean Resort Villas", address: "Westin Kaanapali Ocean Resort Villas Maui", note: "Morning beach day", driveTime: "10 min", driveDist: "4 mi" },
          { label: "Old Lāhainā Lūʻau", address: "Old Lahaina Luau Maui", note: "Gates open 5:15pm", driveTime: "10 min", driveDist: "4 mi" },
          { label: "Westin Ka'anapali Ocean Resort Villas", address: "Westin Kaanapali Ocean Resort Villas Maui", note: "Return after luau" },
        ],
        mapCenter: { lat: 20.9281, lng: -156.6825 },
        mapZoom: 13,
      },
      {
        ...
        waypoints: [
          { label: "Westin Ka'anapali Ocean Resort Villas", address: "Westin Kaanapali Ocean Resort Villas Maui", note: "Morning beach", driveTime: "3 min", driveDist: "0.7 mi" },
          { label: "Hyatt Regency Maui", address: "Hyatt Regency Maui Kaanapali", note: "Drums of the Pacific Luau", driveTime: "3 min", driveDist: "0.7 mi" },
          { label: "Westin Ka'anapali Ocean Resort Villas", address: "Westin Kaanapali Ocean Resort Villas Maui", note: "Return after luau" },
        ],
        mapCenter: { lat: 20.9281, lng: -156.6900 },
        mapZoom: 14,
    ...
    plans: [
      {
        ...
        waypoints: [
          { label: "Westin Ka'anapali Ocean Resort Villas", address: "Westin Kaanapali Ocean Resort Villas Maui", note: "Final beach walk & checkout", driveTime: "10 min", driveDist: "4 mi" },
          { label: "Ululani's Shave Ice Lahaina", address: "Ululani's Hawaiian Shave Ice Lahaina", note: "Last shave ice", driveTime: "45 min", driveDist: "27 mi" },
          { label: "Kahului Airport (OGG)", address: "Kahului Airport Maui", note: "Depart" },
        ],
      ...
      },
      {
        ...
        waypoints: [
          { label: "Westin Ka'anapali Ocean Resort Villas", address: "Westin Kaanapali Ocean Resort Villas Maui", note: "Checkout", driveTime: "14 min", driveDist: "5.5 mi" },
          { label: "Kapalua Bay Beach", address: "Kapalua Bay Beach Maui", note: "Final swim", driveTime: "14 min", driveDist: "5.5 mi" },
          { label: "Ululani's Shave Ice Kahului", address: "Ululani's Hawaiian Shave Ice Kahului", note: "Last shave ice", driveTime: "5 min", driveDist: "2 mi" },
