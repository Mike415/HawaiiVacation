...
const days: Day[] = [
    ...
    plans: [
      {
        ...
        title: "Honua Kai Check-In & Pool Time",
          ...
          {
            title: "Duke's Beach House — First Night Dinner",
            detail: "Duke's Beach House sits right on the sand at Honua Kai Resort — you can practically walk from your suite. Named after legendary surfer Duke Kahanamoku, the open-air oceanfront setting is iconic. Fresh island fish, mai tais, great kids' menu, and live Hawaiian music nightly. One of the most beloved beachfront restaurants on Maui.",
            tip: "Walk-in beachside dining — no reservation needed. The fresh catch, fish tacos, and Duke's famous hula pie are the move. Steps from Honua Kai so no driving needed on arrival night.",
            image: IMAGES.hero,
  ...
  },
  {
    ...
    subtitle: "Kapalua Bay · Napili Bay · Hula Grill Barefoot Bar Dinner",
    plans: [
      {
        label: "Recommended Plan",
        tag: "Beach Day",
        ...
        description: "Kapalua Bay is consistently ranked one of the best family beaches in Hawaii — protected by lava rock headlands that create nearly lagoon-like calm, perfect for your 2yo and 4yo. Start the morning with breakfast at Castaway Café — a charming oceanfront spot just 0.7 miles south of Honua Kai. Then head north to Kapalua Bay (arrive by 8:30am as parking fills by 10am in summer). End the evening with dinner at Hula Grill Barefoot Bar at Whalers Village.",
        activities: [
          {
            title: "Castaway Café — Breakfast",
            detail: "A classic Hawaiian breakfast spot at Maui Ka'anapali Villas, just 0.7 miles south of Honua Kai — a 5-min drive or 20-min walk along the beach path. Set right on Kahekili Beach with gorgeous ocean views. Open for breakfast, lunch, and dinner. The kids' pancakes get rave reviews, and the casual, intimate vibe feels like a hidden gem compared to the big resort restaurants.",
            tip: "Arrive at 7:30–8am for a relaxed breakfast before heading to Kapalua. Walk-in friendly — no reservation needed. Request a table with ocean views. Whale watching is possible from the patio in season.",
            image: IMAGES.kaanapaliKids,
            cost: "~$40–60 for the family",
          },
          {
            title: "Kapalua Bay",
        ...
        logistics: "7:30am: Castaway Café breakfast → 8:30am: Kapalua Bay (arrive early, parking fills by 10am) → Noon: Resort pool if kids are tired, or Napili Bay picnic → 5pm: Hula Grill Barefoot Bar dinner (walk-in)",
        budget: "~$40–60 for Castaway Café breakfast + ~$80–120 for dinner at Hula Grill",
        waypoints: [
          ...
          { label: "Hula Grill Ka'anapali", address: "Hula Grill Ka'anapali, Lahaina, Maui, HI", note: "Barefoot Bar dinner", driveTime: "5 min", driveDist: "1 mi", lat: 20.9248, lng: -156.6929 },
          { label: "Honua Kai Resort & Spa", address: "OUTRIGGER Honua Kai Resort & Spa, 130 Kai Malina Pkwy, Lahaina, Maui, HI", note: "Return to resort", lat: 20.9352, lng: -156.6925 },
        ],
  ...
  },
  {
    ...
    subtitle: "Kapalua Bay Morning · Napili Bay · Leilani's on the Beach Dinner",
    plans: [
      {
        label: "Recommended Plan",
        tag: "Special Dinner",
        tagColor: "#0A4A5C",
        heroImage: IMAGES.kapaluaAerial,
        description: "A beautiful North Ka'anapali day ending with dinner at Leilani's on the Beach — one of Whalers Village's most family-friendly waterfront restaurants, just 5 minutes from Honua Kai. Spend the morning at Kapalua Bay (one of the calmest, most beautiful beaches on Maui), nap window at the resort, then head to Leilani's for a relaxed sunset dinner on the beach. Great kids' menu, casual vibe, and stunning Ka'anapali views.",
        activities: [
          {
        ...
        waypoints: [
          ...
          { label: "Leilani's on the Beach", address: "Leilani's on the Beach, Whalers Village, Lahaina, Maui, HI", note: "Sunset dinner", driveTime: "5 min", driveDist: "1.5 mi", lat: 20.9248, lng: -156.6929 },
          { label: "Honua Kai Resort & Spa", address: "OUTRIGGER Honua Kai Resort & Spa, 130 Kai Malina Pkwy, Lahaina, Maui, HI", note: "Return", lat: 20.9352, lng: -156.6925 },
        ],
    ...
    plans: [
      {
        ...
        logistics: "8am: Kahekili Highway to Kahakuloa overlook → Turn around → 11am: Taverna lunch (Kapalua, 5-min drive from Kahekili start) → 12:30pm: Resort pool → 12:30–3pm: Nap window → 3pm: Monkeypod Kitchen happy hour → Dinner at Monkeypod",
        budget: "~$30–50 for poke bowls and snacks (scenic drive is free) + ~$80–120 for Monkeypod dinner",
        waypoints: [
          ...
          { label: "Monkeypod Kitchen", address: "Monkeypod Kitchen, Whalers Village, Ka'anapali, Maui, HI", note: "Happy hour 3–5:30pm + dinner", driveTime: "5 min", driveDist: "2 mi", lat: 20.9248, lng: -156.6929 },
          { label: "Honua Kai Resort & Spa", address: "OUTRIGGER Honua Kai Resort & Spa, 130 Kai Malina Pkwy, Lahaina, Maui, HI", note: "Return to resort", lat: 20.9352, lng: -156.6925 },
        ],
    ...
    plans: [
      {
        ...
        activities: [
          {
            title: "Slappy Cakes — Breakfast",
            detail: "Directly across the street from Honua Kai — less than 0.1 miles away. Slappy Cakes is an interactive breakfast experience where guests cook their own pancakes right at the table using squeeze bottles of batter. An absolute hit with toddlers and kids. Open daily 7am–12pm.",
            tip: "Arrive at 7:30am to beat the wait — it's extremely popular with families and fills up fast. The kids get to pour their own batter and add toppings, which keeps them engaged for the whole meal. Bring a bib for the 2yo.",
            image: IMAGES.resortFamily,
            cost: "~$40–60 for the family",
          },
          {
            title: "Morning Beach & Pool Day",
            detail: "A free, unstructured morning after breakfast. Let the kids play in the sand, build castles, and splash in the resort pool. This is also a great time to pack any souvenirs and take it slow before the big evening.",
    ...
    plans: [
      {
        ...
        activities: [
          ...
          {
            title: "Café O'Lei at the Plantation — Lunch",
            detail: "The on-site farm-to-table restaurant set in a beautiful historic sugar mill building overlooking the main pond. Café O'Lei at the Plantation serves fresh salads, sandwiches, and local Hawaiian specialties made with ingredients grown on the property. The open-air setting is stunning — surrounded by tropical gardens with views of the West Maui Mountains. Lunch Tue–Fri 11am–2:30pm; happy hour 3–5pm; dinner 5pm.",
            tip: "Reservations recommended — book on OpenTable. The setting is one of the most beautiful on Maui. The mai tai with fruit foam is a standout. Open Tue–Fri for lunch (Day 08 is Thursday, so it's open ✓).",
            image: IMAGES.lahainaTown,
            cost: "~$60–90 for the family",
          },
        ],
        logistics: "9:30am: Drive to Maui Tropical Plantation (20 min) → 10am: Tram tour → Duck & koi pond → Noon: Café O'Lei at the Plantation lunch → 1:30pm: Drive back to resort → 2–4pm: Nap window → 5pm: Final Ka'anapali sunset walk",
...
const budgetRows = [
  ...
  { item: "Dining out (Duke's, Hula Grill, Leilani's, Monkeypod, Maui Brewing Co., etc.)", cost: "~$500–700" },
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-7 gap-3">
            {[
              ...
              },
              {
                ...
                schedule: [
                  { time: "7:30am", label: "Castaway Café breakfast" },
              ...
              },
              {
                ...
                schedule: [
                  ...
                  { time: "11am", label: "Taverna lunch (Kapalua, 5-min drive)" },
                  { time: "↓ 5 min", label: "drive", drive: true },
                  { time: "12:30–3pm", label: "🛏 Nap window at resort" },
                  { time: "3pm", label: "Monkeypod happy hour + dinner" },
                ],
              },
              {
                num: "06", title: "Myths of Maui Lūʻau", icon: "🌴",
                schedule: [
                  { time: "7:30am", label: "Slappy Cakes breakfast (across the street)" },
              ...
              },
              {
                ...
                schedule: [
                  ...
                  { time: "3pm", label: "Monkeypod happy hour (3–5:30pm)" },
                ],
              },
              {
                ...
                schedule: [
                  ...
                  { time: "Noon", label: "Café O'Lei at the Plantation lunch" },
              ...
              restaurants: [
                {
                  ...
                  price: "$$",
                  kidFriendly: 4,
                  reservations: "Walk-in · Arrive 7:30–8am",
                  vibe: "Classic Hawaiian charm tucked into the Maui Ka'anapali Villas, steps from Kahekili Beach. Picturesque and intimate — feels like a locals' secret compared to the big resort restaurants. Ocean views, whale watching in season, and a genuinely relaxed pace.",
                  review: "Consistently praised for its beautiful beach setting and friendly service. Kids' pancakes get rave reviews. Great for breakfast or lunch with toddlers — the outdoor setting means noise is a non-issue. One of the most charming spots in Ka'anapali that most tourists miss.",
                  mustOrder: "Kids' pancakes · Fresh catch · Breakfast plates",
                  hours: "Daily 8am–8pm",
                },
                {
                  name: "Slappy Cakes",
                  ...
                  price: "$$",
                  kidFriendly: 5,
                  reservations: "Walk-in · Arrive 7:30am to beat the wait",
                  vibe: "Interactive pancake restaurant where you cook your own pancakes at the table using squeeze bottles of batter. Playful, chaotic in the best way, and an absolute hit with toddlers. Directly across the street from Honua Kai — it doesn't get more convenient.",
                  review: "Rated a 'Must-Do for Kids' by multiple family travel guides. The kids get to pour batter, add toppings, and flip their own pancakes — keeps them engaged for the entire meal. Expect a wait on summer mornings; arrive early. One of the most unique breakfast experiences on Maui.",
                  mustOrder: "Build-your-own pancakes · Flavored batter add-ons",
                  hours: "Daily 7am–12pm",
                },
                {
              ...
              restaurants: [
                {
                  ...
                  price: "$$$",
                  kidFriendly: 4,
                  reservations: "Recommended · OpenTable · tavernamaui.com",
                  vibe: "Open-air restaurant at the Kapalua Golf Course with stunning views of the West Maui mountains. Executive Chef Edgar Ortiz crafts menus featuring prime grade meats and locally caught fish. A relaxed, vibrant atmosphere that's more scenic than the Ka'anapali beachfront spots.",
                  review: "Dedicated Keiki (kids) menu available — multiple reviews confirm it as a welcoming family restaurant. The open-air setting with mountain views is spectacular. Great happy hour deals (2:30–4:30pm). Praised for prime meats, fresh local fish, and attentive service. A perfect lunch stop on the way back from the Kahekili Highway drive.",
                  mustOrder: "Fresh local catch · Prime meats · Happy hour cocktails",
                  hours: "Lunch 11am–2:30pm · Happy Hour 2:30–4:30pm · Dinner 5–9pm",
                },
                {
                  ...
                  price: "$$$",
                  kidFriendly: 4,
                  reservations: "Recommended · Book ahead for dinner",
                  vibe: "Nestled right on Napili Bay with breathtaking ocean views. Celebrated for its warm Aloha spirit, exceptional service, and varied menu. Ideal for a romantic dinner or casual happy hour. The setting is among the most beautiful on Maui.",
                  review: "Consistently praised for the stunning Napili Bay backdrop and fresh seafood. Great for a dinner if you're already up at Napili Bay or Kapalua. The sunset views are spectacular. More intimate and less crowded than the Ka'anapali beachfront restaurants.",
                  mustOrder: "Fresh catch · Sunset cocktails",
                  hours: "Daily 7am–9pm",
                },
                {
                  ...
                  price: "$$$",
                  kidFriendly: 4,
                  reservations: "Walk-in or call ahead",
                  vibe: "Family-owned sushi bar known for dedication to fresh, high-quality fish and excellent service. A local favorite that offers a wide variety of Nigiri, Sashimi, Specialty Rolls, and Temaki hand rolls. More intimate than the big resort restaurants.",
                  review: "Praised for the quality and freshness of the fish. A great option for a relaxed dinner when you want something different from Hawaiian regional cuisine. The staff are attentive and knowledgeable. Good for families who like sushi.",
                  mustOrder: "Nigiri · Specialty rolls · Temaki hand rolls",
