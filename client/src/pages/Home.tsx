    ...
    plans: [
      {
        ...
        logistics: "8:30am: Kapalua Bay (arrive early, parking fills by 10am) → Noon: Resort pool if kids are tired, or Napili Bay picnic → 5–6pm: Hula Grill Barefoot Bar dinner (walk-in)",
    ...
    plans: [
      {
        ...
        logistics: "8am: Kahekili Highway to Kahakuloa overlook → Turn around → 11:30am: Foodland Farms poke stop → Noon: Ka'anapali Beach picnic → Afternoon: resort pool → 3pm: Monkeypod Kitchen happy hour → Dinner at Monkeypod",
