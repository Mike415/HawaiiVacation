        ...
        plans={[
          {
            ...
            activities: [
              ...
              { title: "Hula Grill Ka'anapali — First Night Dinner ✓ CONFIRMED", detail: "Reservation confirmed: Thursday, May 28 at 6:30 PM · Party of 4. Tables on the sand at Whalers Village, 5 min from Honua Kai. Fresh island fish, mai tais, kids' menu, live Hawaiian music.", tip: "Confirmed 6:30pm, party of 4. Fresh catch and fish tacos are the move. Arrive a few minutes early for a drink at the bar.", cost: "~$80–120 for 2 adults" },
            ],
            logistics: "Alaska AS departs SFO 9:42am → Land OGG 12:05pm → Rental car → Grocery stop (Foodland Farms in Lahaina) → Honua Kai check-in ~2pm → Kids' pool first → 6:30pm: Hula Grill Ka'anapali dinner (confirmed reservation, party of 4)",
