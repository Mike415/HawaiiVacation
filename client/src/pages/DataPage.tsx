    ...
    <div style={{ fontFamily: "Georgia, serif", maxWidth: "860px", margin: "0 auto", padding: "40px 24px", color: "#1a1a1a", lineHeight: 1.7, fontSize: "16px" }}>
        ...
        plans={[
          {
            ...
            activities: [
              { title: "Honua Kai Check-In & Pool Time", detail: "1-Bedroom Partial Ocean View suite. King bed + double sofa bed, full kitchen, in-unit washer/dryer, furnished lanai. Multiple pools including a dedicated kids' pool. Self-parking $35/day.", tip: "Request an upper-floor unit for the best ocean views. Skip Costco on arrival day — it's a 40-min ordeal with tired kids. Hit Foodland Farms Ka'anapali (5 min from resort) for first-night basics instead. Official check-in is 4pm; pool wristbands available at 2:30pm. Pool first, beach second — toddlers do better after a calm arrival." },
        ...
        plans={[
          {
            ...
            activities: [
              ...
              { title: "Hula Grill Ka'anapali — Barefoot Bar Dinner", detail: "Tables literally on the sand at Whalers Village, 5 min from Honua Kai. The open-air Barefoot Bar is legendary — thatched palapas, feet in the sand, fresh island fish, and mai tais. Live Hawaiian music most evenings.", tip: "The Barefoot Bar wait list opens at 4:30pm — put your name in via Yelp Waitlist before leaving the resort, then walk the beach path to Whalers Village. Arriving at 5pm on a summer Thursday means a 45–75 min wait for a sunset table. Or shift to 5:30pm and accept a later sunset view. Fresh catch and fish tacos are the move." },
            ],
        ...
        plans={[
          {
            ...
            activities: [
              ...
              { title: "Big Beach (Oneloa Beach) — Makena State Park", detail: "A sweeping half-mile crescent of golden sand with dramatic views of Molokini and Kaho'olawe. The surf here is bigger than Ka'anapali — keep toddlers in the shallow shore break. Restrooms and parking on-site.", tip: "Leave by 7am — the lot fills by 9:30am in late May. The drive is 55–70 min from Honua Kai. The south end near the lava rock is calmer. Big Beach has a strong shore break — keep toddlers in the shallow wash zone only. Zero shade — bring reef-safe sunscreen, a beach umbrella, and plenty of water.", cost: "Free · Parking fills early" },
      ...
      <DaySection
        ...
        plans={[
          {
            label: "Recommended Plan",
            description: "OGG recommends 2 hours for mainland flights due to the agricultural inspection checkpoint. With a 10:33am departure, you need to be through security by 9am. Wake up at 6am, checkout at 7am, fill gas at Costco Kahului (275 Ho'okele St — cheapest on island, 5 min from OGG), drive to OGG, return car by 8:45am, through security by 9am. Skip the shave ice stop — Ululani's Kahului doesn't open until 10am.",
            activities: [
              ...
              { title: "Checkout & Depart OGG", detail: "7am checkout, fill gas at Costco Kahului (275 Ho'okele St — cheapest on island, 5 min from OGG), drive to OGG, return car by 8:45am, through security by 9am. Car return + shuttle to terminal adds 15 min — don't cut it close with two toddlers. Ululani's Kahului doesn't open until 10am — skip it or grab a treat at the airport.", tip: "Fill gas at Costco Kahului — it's the cheapest on the island and only 5 min from OGG. Skip Ka'anapali gas stations entirely.", cost: "~$0" },
            ],
            logistics: "6am: Final sunrise walk → 7am: Checkout — pack & load car → 7:45am: Fill gas at Costco Kahului (275 Ho'okele St — cheapest, 5 min from OGG) → 8am: Drive to OGG → 8:45am: Return rental car → 9am: Through security → 10:33am: Depart OGG → SFO 6:39pm",
            budget: "~$0 — just gas",
